...
public class RequestsAccepted extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View x = inflater.inflate(R.layout.fragment_requests_accepted,null);

        firebaseAuth = FirebaseAuth.getInstance();

        this.mRecyclerView = (RecyclerView) x.findViewById(R.id.recycle_acc);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot itemSnapshot: dataSnapshot.getChildren()) {
                        for (DataSnapshot rsnapshot : itemSnapshot.getChildren()) {
                            if (rsnapshot.child("accid").getValue(String.class).equals(firebaseAuth.getCurrentUser().getUid())){
                    ...
                    mAdapter = new RecyclerAcc(getContext(),currentItems);
